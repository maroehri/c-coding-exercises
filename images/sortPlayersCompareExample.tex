...
\begin{tikzpicture}[font=\LARGE]
    ...
    \node[left=2cm of team0] (pa) {\texttt{pa}};
    % Pointer von pa auf team[0]
    \node[pointer, right=0.5cm of pa] (pointer_pa) at (pa) {};
    \draw[arrow] (pointer_pa.east) -- (team0.west);
    ...
    \node[left=2cm of team2] (pb) {\texttt{pb}};
    % Pointer von pb auf team[2]
    \node[pointer, right=0.5cm of pb] (pointer_pb) at (pb) {};
    \draw[arrow] (pointer_pb.east) -- (team2.west);
